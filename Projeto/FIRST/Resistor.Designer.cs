...
namespace FIRST
{
    partial class Resistor
    {
        ...
        private void InitializeComponent()
        {
            ...
            // Calculate
            // 
            Calculate.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right;
            Calculate.AutoSize = true;
            Calculate.AutoSizeMode = AutoSizeMode.GrowAndShrink;
            Calculate.BackColor = SystemColors.ButtonHighlight;
            Calculate.Cursor = Cursors.Hand;
            Calculate.Location = new Point(12, 218);
            Calculate.Name = "Calculate";
            Calculate.Size = new Size(66, 25);
            Calculate.TabIndex = 0;
            Calculate.Text = "Calculate";
            Calculate.UseVisualStyleBackColor = false;
            Calculate.Click += Calcular_Click;
            // 
            // label1
            // 
        ...
        private void Calcular_Click(object sender, EventArgs e)
        {
            ...
            if (result <1000)
            {
                ...
                Requivalente.Text = "Resistência Equivalente: " + result.ToString("0.00") + " " + ohmscales[ResistorScale.SelectedIndex];
            ...
            if (result > 999 && result < 9999999)
            {
                ...
                result = result / 1000;
                Requivalente.Text = "Resistência Equivalente: " + result.ToString("0.00") + " " + ohmscales[ResistorScale.SelectedIndex+1] ;
            ...
            if (result > 999999)
            {
                ...
                Requivalente.Text = "Resistência Equivalente: " + result.ToString("0.00") + " " + ohmscales[ResistorScale.SelectedIndex+2];
            }
