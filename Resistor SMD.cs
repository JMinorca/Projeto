...
namespace FIRST
{
    public partial class ResistorSMD : Form
    {
        ...
        public void KeyHandler(object sender, EventArgs e)
        {
            ...
            ButtonColumn_Click(sender, e, clickedButton.Text);
        }
                ...
                case 0: /// resitencia 102
                    {
                        if (palavra[0] != ' ' && palavra[1] != ' ' && palavra[2] != ' ' && protocol == 0)
                        {
                            ...
                            if (palavra[1] != 'R')
                            {
                                ...
                                Output.Text = FormatNumber(resultint) + "Ω";
                            }

                            else
                            {
                                Output.Text = digito1.ToString("0") + "." + digito3.ToString("0") + "Ω";
                            }
                        }
             ...
             break;
                case 1: // resistencia 1002
                {
                    if (palavra[0] != ' ' && palavra[1] != ' ' && palavra[2] != ' ' && palavra[3] != ' ' && protocol == 1)
                    {
                        ...
                        if (palavra[1] == 'R')
                        {
                            Output.Text = digito1.ToString("0") + "." + digito3.ToString("0") + digito4.ToString("0") + "Ω";
                        }
                    }
                    if (palavra[2] == 'R')
                    {
                        Output.Text = digito1.ToString("0") + digito2.ToString("0") + "." + digito4.ToString("0") + "Ω";
                    }
